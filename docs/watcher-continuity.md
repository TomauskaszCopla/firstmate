...
An accepted, unconsumed Pi follow-up without a watcher failure can carry later routine signal/stale closes without another prompt; their durable rows and replacement handoff remain intact, while check-kind closes and continuity failures still get their own prompt.
