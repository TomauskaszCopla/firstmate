...
The internal [`/stow` skill](../.agents/skills/stow/SKILL.md) owns curation and the [explicit-invocation secondmate cascade](../.agents/skills/stow/SKILL.md#automatic-cascade-to-secondmates).
